/**
 * TPOTN — server/seed/data/districts.js
 * Auto-derived from public/js/districts-data.js so the seed data and the
 * frontend never quietly drift apart. Re-run the extraction (see
 * server/seed/README.md) if districts-data.js changes.
 */
